...
export default function Header({ title, subTitle, className }: HeaderProps) {
	...
	return (
		...
		>
			...
			<div className="bg-background mt-26 flex flex-col items-center z-20 px-16 rounded-t-3xl border border-t-4 md:border-0 border-brand-100 dark:border-brand-600 border-b-0 pt-5">
