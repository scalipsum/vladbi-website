...
export default function Tools() {
	...
	return (
		<section ref={sectionRef} className="mt-24 md:mt-40">
			...
			<div className="grid sm:grid-cols-5 w-fit mx-auto gap-5 md:gap-6 mt-8 md:mt-12 grid-cols-3">
				{tools.map((tool, index) => (
					<motion.div
						...
						className={cn(
							'size-24 md:size-32 flex flex-col items-center justify-center rounded-2xl bg-brand-100/50 dark:bg-brand-600 shadow-md transition-all duration-400 hover:scale-115 cursor-default',
